...
pub struct PoolConnection {
    ...
    close_rx: Receiver<Result<(), BoxError>>,
    client: PoolClient,
    idle_timeout: Instant,
}

impl PoolConnection {
    pub fn new(client: PoolClient, close_rx: Receiver<Result<(), BoxError>>) -> Self {
        Self {
            close_rx,
            client,
    ...
    pub fn is_invalid(&self) -> bool {
        if self.client.inner.is_closed() {
            return true;
        }
